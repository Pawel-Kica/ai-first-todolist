...
export const TodoItem = ({
  ...
  return (
    <Card
      className={`shadow-soft border transition-all duration-300 hover:shadow-medium animate-fade-in ${
        todo.completed
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-2 mb-2">
              <h3
                className={`font-semibold text-card-foreground transition-all ${
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <Button
                  ...
                  className="h-8 w-8 p-0 text-muted-foreground hover:text-primary hover:bg-primary-light/20"
                >
